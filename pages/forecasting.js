...
const App = ({ settings: { atms, loadingF, defaultAtmF, surviveAtm }, forecasts: { currentPrediction, currentPerformanceData, currentPerformanceMetaData, currentFeature, currentTopAtms, }, filterForecasts }) => {
    ...
    useEffect(() => {
        if (surviveAtm !== defaultAtmF.atmId) {
            filterForecasts(surviveAtm, atms)
        }
    }, [])
...
const mapDispatchToProps = { filterForecasts };
